...
export class AddressListComponent {
  ...
  createEmptyAddress() {
    return this.fb.group({
      ...
      country: [{ value: 12, disabled: true }],
      street: [{ value: null, disabled: true }],
      city: [{ value: null, disabled: true }],
      city_it: [{ value: null, disabled: true }],
      street_number: [{ value: null, disabled: true }],
  ...
  createAddress(address: any) {
    return this.fb.group({
      ...
      city_it: [{ value: address.city_it, disabled: true }],
      street_number: [{ value: address.street_number, disabled: true }],
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result != null) {
        ...
        if (result.obj.id != 0 && result.obj.id != null) {
          ...
          result.obj.id = result.addressid;
